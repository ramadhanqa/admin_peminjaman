      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="main?thisaction=<?php echo base64_encode('peminjaman'); ?>"><i class="glyphicon glyphicon-heart"></i> Peminjaman</a></li>
            <li><a href="main?thisaction=<?php echo base64_encode('pengembalian'); ?>"><i class="glyphicon glyphicon-star"></i> Pengembalian</a></li>
          </ul>
        </li>
        <!-- <li>
...
if(empty($_GET['thisaction'])){require 'page/home.php';}
  ...
  else if($act=='addpeminjaman'){
    require 'page/addpeminjaman.php';
  }
  ...
  else if($act=='editpeminjaman'){
    require 'page/editpeminjaman.php';
  }
  else if($act=='slider'){
  ...
  else if($act=='peminjaman'){
    require 'page/peminjaman.php';
  }
  else if($act=='pengembalian'){
    require 'page/pengembalian.php';
  }
