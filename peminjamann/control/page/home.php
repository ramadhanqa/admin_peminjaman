        <div class="col-lg-12 col-md-12 col-xs-12">
          ...
          <div class="small-box bg-orange">
            <div class="inner">
<?php $dap=mysqli_fetch_array(mysqli_query($con,"SELECT sum(harga) as tot from peminjaman")); ?>
              <h3><?php if($dap['tot']==NULL){echo "0";}else{echo rp($dap['tot']);} ?></h3>

              <p>Total Harga Semua Peminjaman</p>
            </div>
            <div class="icon" style="margin-top:10px;">
              <i class="glyphicon glyphicon-usd"></i>
            </div>
            <a href="#" class="small-box-footer">Total Harga Peminjaman</a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-12 col-md-12 col-xs-12">
          ...
          <div class="small-box bg-green">
            <div class="inner">
<?php $pen=mysqli_fetch_array(mysqli_query($con,"SELECT sum(harga) as tot from peminjaman")); ?>
            ...
            <a href="#" class="small-box-footer">Total Harga Pengembalian</a>
          </div>
        </div>
...
<?php $user=mysqli_num_rows(mysqli_query($con,"SELECT * from user")); ?>
            ...
            <a href="#" class="small-box-footer">STORE</a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-md-4 col-xs-12">
...
<?php $pro=mysqli_num_rows(mysqli_query($con,"SELECT * from produk")); $ksl=mysqli_fetch_array(mysqli_query($con,"SELECT sum(stok) as stok from produk")); ?>
        ...
        <div class="col-lg-3 col-md-4 col-xs-12">
          ...
          <div class="small-box bg-blue">
            <div class="inner">
<?php $cart=mysqli_num_rows(mysqli_query($con,"SELECT * from rkat_produk")); ?>
            ...
            <a href="#" class="small-box-footer">Seluruh Kategori</a>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-xs-12">
          <!-- small box -->
          <div class="small-box bg-red">
            <div class="inner">
<?php $check=mysqli_num_rows(mysqli_query($con,"SELECT * FROM peminjaman")); ?>
            ...
            <a href="#" class="small-box-footer">Seluruh Peminjaman</a>
          </div>
        </div>
...
<?php $cont=mysqli_num_rows(mysqli_query($con,"SELECT * FROM control")); ?>
        ...
        <div class="col-lg-3 col-md-4 col-xs-12">
          ...
          <div class="small-box bg-red">
            <div class="inner">
<?php $log=mysqli_num_rows(mysqli_query($con,"SELECT * FROM peminjaman")); ?>
            ...
            <a href="#" class="small-box-footer">Seluruh Pengembalian</a>
          </div>
        </div>
        <!-- ./col -->
