      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <h3 class="box-title"><a href="main?thisaction=<?php echo base64_encode('addpeminjaman'); ?>" class="btn btn-circle btn-info btn-sm"><i class="glyphicon glyphicon-plus"></i> Tambah</a></span>&nbsp;Semua Peminjaman</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
<?php $pro=mysqli_query($con,"SELECT * from peminjaman order by id_peminjaman asc");$vr=1;while($duk=mysqli_fetch_array($pro)){ ?>
                  <tr>
                  <!-- <td><?php echo $vr; ?></td> -->
                  ...
                  <td><?php echo $duk['id_kat_produk']; ?></td>
                  ...
                  <td><a class="btn btn-circle btn-success btn-xs" data-target="#tujuan<?php echo $duk['id_peminjaman']; ?>" data-toggle="modal"><i class="glyphicon glyphicon-eye-open"></i> Print</a></td>
