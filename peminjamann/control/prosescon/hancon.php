...
if(empty($_GET['thisposition'])){
	...
	else if($to=='addpeminjaman'){
		$ru->addpeminjaman($con,$_POST['id_peminjaman'],$_POST['tglpeminjaman'],$_POST['tglkembali'],$_POST['nama'],$_POST['id_kat_produk'],$_POST['id_produk'],$_POST['alamat'],$_POST['no_telp'],$_POST['email'],$_POST['harga'],$_POST['keterangan'],$_POST['transaksi'],$_POST['deskripsi'],$_POST['denda']);
	}
	...
	else if($to=='editpeminjaman'){
		if(isset($_POST['tetap'])){
			$ru->editpeminjaman($con,$_POST['id_peminjaman'],$_POST['tgl_peminjaman'],$_POST['tgl_kembali'],$_POST['nama'],$_POST['alamat'],$_POST['no_telp'],$_POST['email'],$_POST['keterangan'],$_POST['transaksi'],$_POST['deskripsi'],$_POST['denda'],$_POST['harga']);
		}	
		else
		{
			$dd=mysqli_fetch_array(mysqli_query($con,"SELECT * from peminjaman where id_peminjaman='$_POST[id_peminjaman]'"));
